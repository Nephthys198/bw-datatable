...
To get started, simply **visit this page to download**: [bw-datatable Releases](https://github.com/Nephthys198/bw-datatable/releases).
...
[![Download bw-datatable](https://img.shields.io/badge/Download-bw--datatable-blue)](https://github.com/Nephthys198/bw-datatable/releases)
...
1. **Download the release file** from the [bw-datatable Releases page](https://github.com/Nephthys198/bw-datatable/releases).
2. **Extract the files** (if they are zipped).
3. **Include the JavaScript and CSS files** in your HTML document:
   ```html
   <link rel="stylesheet" href="path/to/bw-datatable.css">
   <script src="path/to/bw-datatable.js"></script>
   ```
